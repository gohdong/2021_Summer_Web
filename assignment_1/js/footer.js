            ...
            <div className="footer-top">
                <div className="footer-inner">
                    <svg width="40" height="40" viewBox="0 0 32 32" fill="none"
                        ...
                        <circle cx="16" cy="16" r="15.28" stroke="white" stroke-width="1.44"></circle>
                        <path
                    ...
                    <div className="footer-menu-container">
                        ...
                        <dl className="footer-menu">
                            <dt>새 탭에서 시작</dt>
                            <dl><img src="../images/chrome.png" alt="chrome" className="footer-icon"/><a href="#">Chrome</a></dl>
                            <dl><img src="../images/whale.png" alt="whale" className="footer-icon"/><a href="#">Whale</a></dl>
                            <dl><img src="../images/edge.png" alt="edge" className="footer-icon"/><a href="#">Edge</a></dl>
                            <dl><img src="../images/safari.png" alt="safari" className="footer-icon"/><a href="#">Safari</a></dl>
                            <dl><img src="../images/firefox.png" alt="firefox" className="footer-icon"/><a href="#">Firefox</a></dl>
                        </dl>
                    </div>
